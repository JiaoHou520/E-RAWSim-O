    ...
    public class Controller
    {
        ...
        public Controller(Instance instance)
        {
            ...
            switch (instance.ControllerConfig.OrderBatchingConfig.GetMethodType())
            {
                ...
                case OrderBatchingMethodType.GM1: OrderManager = new GM1Manager(instance);break;
                case OrderBatchingMethodType.GM2: OrderManager = new GM2Manager(instance); break;
