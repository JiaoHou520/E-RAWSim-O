                ...
                !_repositioningBots.Contains(bot))
            {
                    ...
                    _stationWorkerCount[s] < _config.BotsPerStationLimit))
                {
                    ...
                    if (station is OutputStation)
                    {
                        ...
                        else if(Instance.ControllerConfig.OrderBatchingConfig is GM1Configuration || Instance.ControllerConfig.OrderBatchingConfig is GM2Configuration)//使用Gurobi
                        {
                        ...
                        {
                            success = DoExtractTaskForStation2(bot, station as OutputStation,
                            // Extended search options
                             _config.ExtendSearch);
                        }
                        if (success)
